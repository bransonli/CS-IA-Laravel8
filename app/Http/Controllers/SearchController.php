    ...
    public function search()
    {
        ...
        for ($x = 0; $x < count($words); $x++) {
            for ($y = 0; $y < count($discussions); $y++) {
                ...
                if (strstr($discussion_name, $words[$x])){
            ...
            for ($y = 0; $y < count($replies); $y++) {
                ...
                if (strstr($reply_content, $words[$x])){
            ...
            for ($y = 0; $y < count($notes); $y++) {
                ...
                if (strstr($note_name, $words[$x])){
                    array_push($related_notes, $notes[$x]);
                } elseif (strstr($note_description, $words[$x])) {
                    array_push($related_notes, $notes[$x]);
                }
            }
            ...
            for ($y = 0; $y < count($resources); $y++) {
                ...
                if (strstr($resource_name, $words[$x])){
                    array_push($related_resources, $resources[$x]);
                } elseif (strstr($resource_description, $words[$x])){
                    array_push($related_resources, $resources[$x]);
                }
            }
        } 
