    ...
    <tbody>
        @foreach ($notes as $note)
          <tr>
            ...
            <td>
              <a href='/subjects/{{$subject->name}}/note/{{$note->id}}/download'><button class="btn btn-light">
              ...
              <a href='/subjects/{{$subject->name}}/note/{{$note->id}}/delete'><button class="btn btn-light">
